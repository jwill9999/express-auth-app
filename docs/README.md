...
System design, database schemas, and technical architecture decisions.

- [Overview](./architecture/overview.md) - High-level system architecture
- [Database Schema](./architecture/database-schema.md) - MongoDB collections and models
...
- [Authentication](./api/authentication.md) - Auth-specific endpoints
...
- [Setup](./guides/setup.md) - Getting started guide
